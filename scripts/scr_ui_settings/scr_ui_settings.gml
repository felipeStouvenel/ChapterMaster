function scr_ui_settings() {
    ...
    if (menu = 21) {
        ...
        for (var derpaderp = 1; derpaderp <= 14; derpaderp++) {
            ...
            if (obj_ini.race[100, ide] != 0) { // Creates mass_equip here
                ...
                if (scr_hit(xxx, yyy, xxx + 289, yyy + 20) = true) {
                    /*if (custom=2) then draw_set_alpha(0.2);if (custom<2) then */
                    draw_set_alpha(0.1);
                    draw_set_color(c_white);
                    draw_rectangle(xxx, yyy, xxx + 289, yyy + 20, 0);
                    draw_set_alpha(1);
        ...
        for (var i = 1; i <= 11; i++) {
            ...
            if (i > 2) {
                if (bat_formation[i] = "") and(bat_formation[i - 1] != "") then draw_rectangle(xxx, yyy, xxx + 289, yyy + 20, 0);
            }
            ...
            if (shw != "") or(isnew = true) {
                ...
                if (scr_hit(xxx, yyy, xxx + 289, yyy + 20) = true) {
                    ...
                    if (i <= 3) then tool1 = string(shw) + " Settings";
