    ...
    if (menu = 1) and(managing > 0) {
        ...
        if (instance_exists(cn)) {
            if (cn.temp[101] != "") and(cn.temp[100] = "1") {
                ...
                var show_wep1 = string_replace(cn.temp[108], "Arti. ", "");
                var show_wep2 = string_replace(cn.temp[110], "Arti. ", "");
                var show_arm = string_replace(cn.temp[102], "Arti. ", "");
                var show_gear = string_replace(cn.temp[104], "Arti. ", "");
                var show_mobi = string_replace(cn.temp[106], "Arti. ", "");

                if (ui_specialist = 7) or(ui_specialist = 1) or(ui_specialist = 111) {
                    for (var o = 1; o <= 4; o++) {
                        if (obj_ini.adv[o] = "Reverent Guardians") then braz = 1;
                    }
                }
                ...
                if (show_gear = "Servo Arms") or(show_gear = "Master Servo Arms") {
                    ...
                    if (mas > 0) {
                        if (cspec = 0) then arm = 10;
                        if (cspec = 1) then arm = 11;
                        if (cspec >= 2) then arm = 12;
                    }
                }
                ...
                if (shader_is_compiled(sReplaceColor)) {
                    ...
                    */
                    ...
                    if (temp[102] != "") {
                        var yep = 0;
                        for (var o = 1; o <= 4; o++) {
                            if (obj_ini.adv[o] = "Slow and Purposeful") then slow = 1;
                        }
                        if (ui_specialist = 5) {
                            yep = 0;
                            for (var o = 1; o <= 4; o++) {
                                if (obj_ini.adv[o] = "Tech-Brothers") then brothers = 0;
                            }
                        }
                    }
                    ...
                    if (show_arm != "Dreadnought") and(cspec <= 1) and(temp[102] != "") {
                        if (ui_arm[1] = true) then draw_sprite(armour_sprite, 6, xx + 1208, yy + 178);
                        if (ui_arm[2] = true) then draw_sprite(armour_sprite, 8, xx + 1208, yy + 178);
                    }
                    if (show_arm != "Dreadnought") and(cspec >= 2) and(temp[102] != "") {
                        if (ui_arm[1] = true) then draw_sprite(armour_sprite, 6, xx + 1208, yy + 178);
                        if (ui_arm[2] = true) then draw_sprite(armour_sprite, 9, xx + 1208, yy + 178);
                    }
                    ...
                    if (hood > 0) and(temp[102] != "") {
                        ...
                        for (var o = 1; o <= 4; o++) {
                            if (obj_ini.adv[o] = "Daemon Binders") and(blandify = 0) then yep = 1;
                        }
                        if (yep = 0) or(hood >= 7) {
                ...
                draw_set_color(c_gray);
                draw_rectangle(xx + 1208, yy + 178, xx + 1374, yy + 409, 1);
            ...
            for (var i = 0; i < repetitions; i++) {
                ...
                if (man[sel] = "vehicle") {
                    ...
                    temp3 = string(round(ma_health[sel])) + "% HP";
                    temp4 = "";
