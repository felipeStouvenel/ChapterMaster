function scr_add_man(man_role, target_company, choice_armour, choice_weapons, choice_gear, spawn_exp, spawn_name, corruption, other_gear, home_spot, mobility_items) {
    ...
    if (good != 0) {
        ...
        if (string_count("ship", home_spot) > 0) or((obj_ini.fleet_type != 1) and(home_spot = "default")) {
            ...
            var wop = instance_nearest(x, y, obj_p_fleet);
        ...
        if (other_gear = true) {
            switch (man_role) {
                case "Skitarii":
                    ...
                    obj_ini.wep2[target_company, good] = "";
                    obj_ini.armor[target_company, good] = "Skitarii Armour";
                ...
                case "Techpriest":
                    ...
                    obj_ini.armor[target_company, good] = "Dragon Scales";
                ...
                case "Crusader":
                    ...
                    obj_ini.armor[target_company, good] = "Power Armour";
                ...
                case "Flash Git":
                    ...
                    obj_ini.wep2[target_company, good] = "Choppa";
                    obj_ini.armor[target_company, good] = "Ork Armour";
        ...
        // Weapons
        if (choice_weapons = obj_ini.role[100, 12]) {
            wep2 = obj_ini.wep2[100, 12];
            wep1 = obj_ini.wep1[100, 12];
            arm = obj_ini.armor[100, 12];
        }
            ...
            if (arm != "") then repeat(100) { // Armour
                ...
                if (e <= 100) {
                    if (obj_ini.equipment[e] = arm) {
                        obj_ini.equipment_number[e] -= 1;
                        obj_ini.armor[target_company, good] = arm;
                        if (obj_ini.equipment_number[e] = 0) {
                            obj_ini.equipment[e] = "";
                            obj_ini.equipment_type[e] = "";
                        }
