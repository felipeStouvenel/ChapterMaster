function scr_ui_popup() {
    if (obj_controller.menu = 60) {
        var xx, yy;
        xx = __view_get(e__VW.XView, 0) + 25;
        ...
        var title, ups;
        title = "";
        ups = obj_temp_build.lair + obj_temp_build.arsenal + obj_temp_build.gene_vault;
        ...
        if (obj_temp_build.isnew = 1) {
            ...
            repeat(9) {
                ...
                if (r = 3) {
                    wob = "Feudal";
                    word = "Mortar and brick surfaces with wood furnishings.";
                }
                if (r = 4) {
                    wob = "Gothic";
                ...
                draw_set_color(c_gray);
                draw_rectangle(xx + 21, yy + 38 + (r * 30), xx + 600, yy + 56 + (r * 30), 0);
        ...
        if (ups > 0) and(obj_temp_build.lair > 0) {
            ...
            if (planet_feature_bool(planet_features, P_features.Secret_Base) == 0) {
                ...
                if (s_base.inquis_hidden != 1) {
                    secret = false;
                }
            }

            var r, butt, alp, cost, fuck, tooltip, tooltip2, tooltip3, tooltip4, tcost;
            r = 0;
            tcost = 0;
            butt = "";
            alp = 1;
            ...
            repeat(12) {
                ...
                cost = 0;
                if (r = 1) {
                    if (fuck.forge > 0) then alp = 0.33;
                    cost = 1000;
                    butt = "Forge";
                    tooltip2 = "A modest, less elaborate forge able to employ a handful of Astartes or Techpriest.";
                }
                if (r = 2) {
                    if (fuck.hippo > 0) then alp = 0.33;
                    cost = 1000;
                    butt = "Hippodrome";
                    tooltip2 = "A moderate sized garage fit to hold, service, and display vehicles.";
                }
                if (r = 3) {
                    if (fuck.beastarium > 0) then alp = 0.33;
                    cost = 1000;
                    butt = "Beastarium";
                    tooltip2 = "An enclosure with simulated greenery and foilage meant to hold beasts.";
                }
                if (r = 4) {
                    if (fuck.torture > 0) then alp = 0.33;
                    cost = 500;
                    butt = "Torture Chamber";
                    tooltip2 = "Only the best for the best.  A room full of torture tools and devices.";
                }
                if (r = 5) {
                    if (fuck.narcotics > 0) then alp = 0.33;
                    cost = 500;
                    butt = "Narcotics";
                    tooltip2 = "Several boxes worth of Obscura, Black Lethe, Kyxa... line it up.";
                }
                if (r = 6) {
                    if (fuck.relic > 0) then alp = 10 + fuck.relic;
                    cost = 500;
                    butt = "Relic Room";
                    tooltip2 = "A room meant for displaying trophies.  May be purchased successive times.";
                }
                if (r = 7) {
                    if (fuck.cookery > 0) then alp = 0.33;
                    cost = 250;
                    butt = "Cookery";
                    tooltip2 = "A larger, well-stocked cookery, complete with a number of Imperial Chef servants.";
                }
                if (r = 8) {
                    if (fuck.vox > 0) then alp = 0.33;
                    cost = 250;
                    butt = "Vox Casters";
                    tooltip2 = "All the bass one could ever imaginably need.";
                }
                if (r = 9) {
                    if (fuck.librarium > 0) then alp = 0.33;
                    cost = 250;
                    butt = "Librarium";
                    tooltip2 = "A study fit to hold a staggering amount of tomes and scrolls.";
                }
                if (r = 10) {
                    if (fuck.throne > 0) then alp = 0.33;
                    cost = 250;
                    butt = "Throne";
                    tooltip2 = "A massive, ego boosting throne.";
                }
                if (r = 11) {
                    if (fuck.stasis > 0) then alp = 0.33;
                    cost = 200;
                    butt = "Stasis Pods";
                    tooltip2 = "Though they start empty, you may capture and display your foes in these.";
                }
                if (r = 12) {
                    if (fuck.swimming > 0) then alp = 0.33;
                    cost = 100;
                    butt = "Swimming Pool";
                    tooltip2 = "A large body of water meant for excersize or relaxation.";
                }
                tooltip = butt;
                ...
                draw_set_color(c_black);
                draw_text_transformed(xx + 496, yy + 14 + ((r - 1) * 22), string_hash_to_newline(string(butt)), 1, 0.9, 0);
                draw_set_alpha(1);
                ...
                if (scr_hit(xx + 494, yy + 12 + ((r - 1) * 22), xx + 614, yy + 32 + ((r - 1) * 22)) = true) {
                    ...
                    if (obj_controller.mouse_left = 1) and(obj_controller.cooldown <= 0) and(obj_controller.requisition >= tcost) and(alp != 0.33) {
                        ...
                        if (r = 1) {
                            fuck.forge += 1;
                            fuck.target.p_upgrades[obj_controller.selecting_planet] += "forge|";
                        }
                        if (r = 2) {
                            fuck.hippo += 1;
                            fuck.target.p_upgrades[obj_controller.selecting_planet] += "hippo|";
                        }
                        if (r = 3) {
                            fuck.beastarium += 1;
                            fuck.target.p_upgrades[obj_controller.selecting_planet] += "beast|";
                        }
                        if (r = 4) {
                            fuck.torture += 1;
                            fuck.target.p_upgrades[obj_controller.selecting_planet] += "tort|";
                        }
                        if (r = 5) {
                            fuck.narcotics += 1;
                            fuck.target.p_upgrades[obj_controller.selecting_planet] += "narc|";
                        }
                        if (r = 6) {
                            fuck.relic += 1;
                            fuck.target.p_upgrades[obj_controller.selecting_planet] += "$";
                        }
                        if (r = 7) {
                            fuck.cookery += 1;
                            fuck.target.p_upgrades[obj_controller.selecting_planet] += "cook|";
                        }
                        if (r = 8) {
                            fuck.vox += 1;
                            fuck.target.p_upgrades[obj_controller.selecting_planet] += "vox|";
                        }
                        if (r = 9) {
                            fuck.librarium += 1;
                            fuck.target.p_upgrades[obj_controller.selecting_planet] += "libra|";
                        }
                        if (r = 10) {
                            fuck.throne += 1;
                            fuck.target.p_upgrades[obj_controller.selecting_planet] += "throne|";
                        }
                        if (r = 11) {
                            fuck.stasis += 1;
                            fuck.target.p_upgrades[obj_controller.selecting_planet] += "stas|";
                        }
                        if (r = 12) {
                            fuck.swimming += 1;
                            fuck.target.p_upgrades[obj_controller.selecting_planet] += "swim|";
                        }
                    }
                }
            }
            ...
            if (secret = true) then woob += "secret lair.  ";
            if (secret = false) then woob += "previously discovered lair.  ";
            var upp;
            upp = "";
            upp = string(fuck.target.p_upgrades[obj_controller.selecting_planet]);
            ...
            hh = 1;
            repeat(2) {
                if (((string_height_ext(string_hash_to_newline(string(woob)), -1, 470)) * hh) > 330) then hh -= 0.1;
            }
            ...
            if (tooltip3 != "") {
                ...
                draw_set_font(fnt_40k_14);
                draw_text_ext(mouse_x + 22, mouse_y + 42, string_hash_to_newline(string(tooltip4)), -1, 500);
        ...
        if (ups > 0) and(obj_temp_build.lair = 0) {
            ...
            if (obj_temp_build.gene_vault > 0) {
                if (secret = true) then woob = "A large facility with Gene-Vaults and additional spare rooms, this structure safely stores the majority of your Gene-Seed and is ran by servitors.  Due to its secret nature you may amass Gene-Seed and Test-Slave Incubators without fear of Inquisition reprisal or taking offense.";
        ...
        if (ups < 0) {
            draw_set_font(fnt_40k_14b);
            draw_text(xx + 21, yy + 65, string_hash_to_newline("This feature will be constructed in " + string(ups * -1) + " months."));
        }
        if (ups = 0) {
            draw_set_font(fnt_40k_14b);
            if (obj_temp_build.lair = 0) then draw_text(xx + 21, yy + 45, string_hash_to_newline("Lair"));
            if (obj_temp_build.arsenal = 0) then draw_text(xx + 21, yy + 110, string_hash_to_newline("Arsenal"));
            if (obj_temp_build.gene_vault = 0) then draw_text(xx + 21, yy + 175, string_hash_to_newline("Gene-Vault"));
            draw_set_font(fnt_40k_14);

            draw_sprite(spr_requisition, 0, xx + 160, yy + 47);
            draw_set_color(16291875);
            if (obj_controller.requisition < 1000) then draw_set_color(c_red);
            ...
            draw_set_color(16291875);
            if (obj_controller.requisition < 1500) then draw_set_color(c_red);
    ...
    if (popup > 0) and(selected != 0) and(zoomed = 0) and(sel_system_x + sel_system_y = 0) and(diplomacy <= 0) and(instance_exists(obj_fleet_select)) {
        ...
        repeat(es + fr + ca + ty) {
            ...
            if (posi <= ca) {
                ...
                if (string_width(string_hash_to_newline(nem)) * scale > 179) then repeat(9) {
                ...
                if (mouse_x >= __view_get(e__VW.XView, 0) + x3) and(mouse_x < __view_get(e__VW.XView, 0) + x3 + 209) and(mouse_y >= __view_get(e__VW.YView, 0) + y3) and(mouse_y <= __view_get(e__VW.YView, 0) + y3 + 18) {
                    if (string_width(string_hash_to_newline(nem)) * scale > 135) then repeat(9) {
            ...
            if (posi > ca + fr) and(posi <= ca + fr + es) {
                ...
                if (mouse_check_button_pressed(mb_left)) and(cooldown <= 0) {
                    if (mouse_x >= __view_get(e__VW.XView, 0) + x3) and(mouse_x < __view_get(e__VW.XView, 0) + x3 + 25) and(mouse_y >= __view_get(e__VW.YView, 0) + y3) and(mouse_y <= __view_get(e__VW.YView, 0) + y3 + 18) {
                        ...
                        if (robj.escort_sel[shit] = 1) and(onceh = 0) {
                            robj.escort_sel[shit] = 0;
                            onceh = 1;
                        }
                        if (robj.escort_sel[shit] = 0) and(onceh = 0) {
                            robj.escort_sel[shit] = 1;
                            onceh = 1;
                        }
                    }
                }
    ...
    if (scr_hit(xx + 5, yy + 10, xx + 137, yy + 38) = true) and(zoomed = 0) {
        ...
        if (obj_ini.fleet_type = 1) {
            ...
            tool1 += "Base Income: " + string(plu) + string(income_base);
            tool2 += "Base Income: ";
            plu = "";
            if (income_home > 0) then plu = "+";
            tool1 += "#Fortress Monastery Bonus: " + string(plu) + string(income_home);
            tool2 += "#Fortress Monastery Bonus: ";
            plu = "";
            if (income_forge > 0) then plu = "+";
            if (income_forge > 0) {
                tool1 += "#Nearby Forge Worlds: " + string(plu) + string(income_forge);
                tool2 += "#Nearby Forge Worlds:";
            }
            plu = "";
            if (income_agri > 0) then plu = "+";
            if (income_forge > 0) {
                tool1 += "#Nearby Agri Worlds: " + string(plu) + string(income_agri);
                tool2 += "#Nearby Agri Worlds:";
            }
            plu = "";
            if (income_recruiting > 0) then plu = "+";
            if (income_recruiting != 0) {
                tool1 += "#Astartes Recruitment: " + string(plu) + string(income_recruiting);
                tool2 += "#Astartes Recruitment:";
            }
            plu = "";
            if (income_training > 0) then plu = "+";
            if (income_training != 0) {
                tool1 += "#Specialist Training: " + string(plu) + string(income_training);
                tool2 += "#Specialist Training:";
            }
            plu = "";
            if (income_fleet > 0) then plu = "+";
            tool1 += "#Fleet Maintenance: " + string(plu) + string(income_fleet);
            tool2 += "#Fleet Maintenance:";
            plu = "";
            if (income_tribute > 0) then plu = "+";
            if (income_tribute != 0) {
                tool1 += "#Planet Tithes: " + string(plu) + string(income_tribute);
                tool2 += "#Planet Tithes:";
            }
        }
        if (obj_ini.fleet_type != 1) {
        ...
        if (tool1 != "") {
            draw_set_color(0);
            draw_rectangle(xx + 10, yy + 42, xx + string_width(string_hash_to_newline(tool1)) + 16, yy + string_height(string_hash_to_newline(tool1)) + 48, 0);
            draw_set_color(c_gray);
            draw_rectangle(xx + 10, yy + 42, xx + string_width(string_hash_to_newline(tool1)) + 16, yy + string_height(string_hash_to_newline(tool1)) + 48, 1);
            draw_set_alpha(0.5);
            draw_rectangle(xx + 11, yy + 43, xx + string_width(string_hash_to_newline(tool1)) + 15, yy + string_height(string_hash_to_newline(tool1)) + 47, 1);
            draw_set_alpha(1);
            draw_set_font(fnt_40k_14);
            draw_set_halign(fa_left);
    ...
    if (scr_hit(xx + 813, yy + 10, xx + 960, yy + 38) = true) and(penitent = 1) and(zoomed = 0) {
        ...
        if (obj_controller.blood_debt = 1) {
            tool1 = "Blood Spilled: " + string(penitent_current);
            tool2 = "Blood Spilled: ";
            tool1 += "#Blood Debt: " + string(penitent_max);
            tool2 += "#Blood Debt: ";
            tool1 += "#Decay Rate: " + string(endb);
            tool2 += "#Decay Rate: ";
        ...
        if (obj_controller.blood_debt = 0) {
            tool1 = "Current Penitence: " + string(penitent_current);
            tool2 = "Current Penitence: ";
            tool1 += "#Required Penitence: " + string(penitent_max);
            tool2 += "#Required Penitence: ";
        ...
        if (tool1 != "") {
            ...
            draw_set_color(c_gray);
            draw_rectangle(xx + 813, yy + 42, xx + string_width_ext(string_hash_to_newline(tool1), -1, 400) + 819, yy + string_height_ext(string_hash_to_newline(tool1), -1, 400) + 23 + hei_bonus, 1);
            draw_set_alpha(0.5);
