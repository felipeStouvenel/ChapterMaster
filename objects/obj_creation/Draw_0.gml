    ...
    if (slide = 1) {
        ...
        repeat(9) {
            ...
            if (mouse_x >= x2) and(mouse_y >= 167) and(mouse_x < x2 + 48) and(mouse_y < 167 + 48) and(slate4 >= 30) {
                if (old_highlight != highlight) and(highlight != i) and(goto_slide != 2) {
...
if (slide >= 2) {
    ...
    obj_cursor.image_index = 0;
    if (scr_hit(436, 74, 436 + 128, 74 + 128) = true) and(popup = "") {
        obj_cursor.image_index = 1;
    ...
    if (slide = 2) {
        ...
        if (founding != 0) {
            ...
            if (scr_hit(1164 - 128, 74, 1164, 74 + 128) = true) {
            ...
            if (custom > 1) {
                ...
                if (scr_hit(1164 - 194, 149, 1164 - 162, 193) = true) {
                    obj_cursor.image_index = 1;
                ...
                if (scr_hit(1164 - 144, 149, 1164 - 112, 193) = true) {
                    obj_cursor.image_index = 1;
                    if (cooldown <= 0) and(mouse_left >= 1) {
                        cooldown = 8000;
                        founding += 1;
...
if (slide = 2) {
    ...
    if (popup = "") {
        ...
        if (scr_hit(516, 242, 674, 266) = true) {
            tooltip = "Homeworld";
        ...
        if (scr_hit(768, 242, 866, 266) = true) {
            tooltip = "Fleet Based";
        ...
        if (scr_hit(952, 242, 1084, 266) = true) {
            tooltip = "Penitent";
        ...
        yar = 0;
        if (scr_hit(519, 239, 519 + 32, 239 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom = 2) {
            cooldown = 8000;
            if (points + 20 <= maxpoints) and(fleet_type = 3) {
                points += 20;
                fleet_type = 1;
            }
            if (fleet_type = 2) {
        ...
        yar = 0;
        if (scr_hit(771, 239, 771 + 32, 239 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom = 2) {
            cooldown = 8000;
            if (points + 20 <= maxpoints) and(fleet_type = 3) {
                points += 20;
                fleet_type = 2;
        ...
        yar = 0;
        if (scr_hit(958, 239, 958 + 32, 239 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom = 2) {
            if (fleet_type != 3) then points -= 20;
            fleet_type = 3;
            cooldown = 8000;
        }
        ...
        if (scr_hit(625, 325, 657, 357) = true) {
            obj_cursor.image_index = 1;
            if (cooldown <= 0) and(custom = 2) and(strength > 1) and(mouse_left >= 1) {
                strength -= 1;
                points -= 10;
                cooldown = 8000;
            }
        ...
        if (scr_hit(625, 380, 657, 412) = true) {
            obj_cursor.image_index = 1;
            if (cooldown <= 0) and(custom = 2) and(cooperation > 1) and(mouse_left >= 1) {
                cooperation -= 1;
                points -= 10;
                cooldown = 8000;
            }
        ...
        if (scr_hit(625, 435, 657, 467) = true) {
            obj_cursor.image_index = 1;
            if (cooldown <= 0) and(custom = 2) and(purity > 1) and(mouse_left >= 1) {
                purity -= 1;
                points -= 10;
                cooldown = 8000;
            }
        ...
        if (scr_hit(625, 490, 657, 522) = true) {
            obj_cursor.image_index = 1;
            if (cooldown <= 0) and(custom = 2) and(stability > 1) and(mouse_left >= 1) {
                stability -= 1;
                points -= 10;
                cooldown = 8000;
            }
        ...
        if (scr_hit(1135, 325, 1167, 357) = true) {
            obj_cursor.image_index = 1;
            if (cooldown <= 0) and(custom = 2) and(strength < 10) and(points + 10 <= maxpoints) and(mouse_left >= 1) {
                strength += 1;
                points += 10;
                cooldown = 8000;
            }
        ...
        if (scr_hit(1135, 380, 1167, 412) = true) {
            obj_cursor.image_index = 1;
            if (cooldown <= 0) and(custom = 2) and(cooperation < 10) and(points + 10 <= maxpoints) and(mouse_left >= 1) {
                cooperation += 1;
                points += 10;
                cooldown = 8000;
            }
        ...
        if (scr_hit(1135, 435, 1167, 467) = true) {
            obj_cursor.image_index = 1;
            if (cooldown <= 0) and(custom = 2) and(purity < 10) and(points + 10 <= maxpoints) and(mouse_left >= 1) {
                purity += 1;
                points += 10;
                cooldown = 8000;
            }
        ...
        if (scr_hit(1135, 490, 1167, 522) = true) {
            obj_cursor.image_index = 1;
            if (cooldown <= 0) and(custom = 2) and(stability < 10) and(points + 10 <= maxpoints) and(mouse_left >= 1) {
                stability += 1;
                points += 10;
                cooldown = 8000;
            }
        ...
        if (scr_hit(532, 325, 1166, 357) = true) {
            tooltip = "Strength";
        ...
        if (scr_hit(486, 380, 1166, 412) = true) {
            tooltip = "Cooperation";
        ...
        if (scr_hit(442, 435, 1166, 467) = true) {
            tooltip = "Purity";
        ...
        if (scr_hit(423, 490, 1166, 522) = true) {
            tooltip = "Stability";
    ...
    if (popup != "icons") {
        draw_set_halign(fa_left);
        draw_set_font(fnt_40k_30b);
        draw_text_transformed(436, 564, string_hash_to_newline("Chapter Advantages"), 0.5, 0.5, 0);
        draw_set_font(fnt_40k_14);
        if (adv_num[1] = 0) then draw_text(436, 590, string_hash_to_newline("[+]"));
        if (adv_num[1] > 0) then draw_text(436, 590, string_hash_to_newline("[-] " + string(adv[1])));
        if (adv_num[2] = 0) and(adv_num[1] > 0) then draw_text(436, 610, string_hash_to_newline("[+]"));
        if (adv_num[2] > 0) then draw_text(436, 610, string_hash_to_newline("[-] " + string(adv[2])));
        if (adv_num[3] = 0) and(adv_num[2] > 0) then draw_text(436, 630, string_hash_to_newline("[+]"));
        if (adv_num[3] > 0) then draw_text(436, 630, string_hash_to_newline("[-] " + string(adv[3])));
        if (adv_num[4] = 0) and(adv_num[3] > 0) then draw_text(436, 650, string_hash_to_newline("[+]"));
        if (adv_num[4] > 0) then draw_text(436, 650, string_hash_to_newline("[-] " + string(adv[4])));

        draw_set_font(fnt_40k_30b);
        draw_text_transformed(810, 564, string_hash_to_newline("Chapter Disadvantages"), 0.5, 0.5, 0);
        draw_set_font(fnt_40k_14);
        if (dis_num[1] = 0) then draw_text(810, 590, string_hash_to_newline("[+]"));
        if (dis_num[1] > 0) then draw_text(810, 590, string_hash_to_newline("[-] " + string(dis[1])));
        if (dis_num[2] = 0) and(dis_num[1] > 0) then draw_text(810, 610, string_hash_to_newline("[+]"));
        if (dis_num[2] > 0) then draw_text(810, 610, string_hash_to_newline("[-] " + string(dis[2])));
        if (dis_num[3] = 0) and(dis_num[2] > 0) then draw_text(810, 630, string_hash_to_newline("[+]"));
        if (dis_num[3] > 0) then draw_text(810, 630, string_hash_to_newline("[-] " + string(dis[3])));
        if (dis_num[4] = 0) and(dis_num[3] > 0) then draw_text(810, 650, string_hash_to_newline("[+]"));
        if (dis_num[4] > 0) then draw_text(810, 650, string_hash_to_newline("[-] " + string(dis[4])));

        if (scr_hit(436, 564, 631, 583) = true) {
        ...
        if (scr_hit(810, 564, 1030, 583) = true) {
    ...
    if (popup != "icons") {
        if (scr_hit(436, 590, 640, 619) = true) {
            if (adv_num[1] != 0) {
                tooltip = advantage[adv_num[1]];
                tooltip2 = advantage_tooltip[adv_num[1]];
            }
            if (mouse_left >= 1) and(cooldown <= 0) and(points + 20 <= maxpoints) and(adv_num[1] = 0) and(popup = "") and(custom > 1) {
                popup = "advantages";
                cooldown = 8000;
                temp = 1;
            }
            if (mouse_left >= 1) and(mouse_x <= 456) and(adv_num[1] > 0) and(adv_num[2] = 0) and(cooldown <= 0) and(custom > 1) {
                points -= 20;
                adv[1] = "";
                adv_num[1] = 0;
                cooldown = 8000;
        ...
        if (scr_hit(436, 610, 640, 639) = true) {
            if (adv_num[2] != 0) {
                tooltip = advantage[adv_num[2]];
                tooltip2 = advantage_tooltip[adv_num[2]];
            }
            if (mouse_left >= 1) and(cooldown <= 0) and(points + 20 <= maxpoints) and(adv_num[2] = 0) and(adv_num[1] != 0) and(popup = "") and(custom > 1) {
                popup = "advantages";
                cooldown = 8000;
                temp = 2;
            }
            if (mouse_left >= 1) and(mouse_x <= 456) and(adv_num[2] > 0) and(adv_num[3] = 0) and(cooldown <= 0) and(custom > 1) {
                points -= 20;
                adv[2] = "";
                adv_num[2] = 0;
                cooldown = 8000;
        ...
        if (scr_hit(436, 630, 640, 659) = true) {
            if (adv_num[3] != 0) {
                tooltip = advantage[adv_num[3]];
                tooltip2 = advantage_tooltip[adv_num[3]];
            }
            if (mouse_left >= 1) and(cooldown <= 0) and(points + 20 <= maxpoints) and(adv_num[3] = 0) and(adv_num[2] != 0) and(popup = "") and(custom > 1) {
                popup = "advantages";
                cooldown = 8000;
                temp = 3;
            }
            if (mouse_left >= 1) and(mouse_x <= 456) and(adv_num[3] > 0) and(adv_num[4] = 0) and(cooldown <= 0) and(custom > 1) {
                points -= 20;
                adv[3] = "";
                adv_num[3] = 0;
                cooldown = 8000;
        ...
        if (scr_hit(436, 650, 640, 679) = true) {
            if (adv_num[4] != 0) {
                tooltip = advantage[adv_num[4]];
                tooltip2 = advantage_tooltip[adv_num[4]];
            }
            if (mouse_left >= 1) and(cooldown <= 0) and(points + 20 <= maxpoints) and(adv_num[4] = 0) and(adv_num[3] != 0) and(popup = "") and(custom > 1) {
                popup = "advantages";
                cooldown = 8000;
                temp = 4;
            }
            if (mouse_left >= 1) and(mouse_x <= 456) and(adv_num[4] > 0) and(cooldown <= 0) and(custom > 1) {
                points -= 20;
                adv[4] = "";
                adv_num[4] = 0;
                cooldown = 8000;
        ...
        if (scr_hit(810, 590, 1014, 619) = true) {
            if (dis_num[1] != 0) {
                tooltip = disadvantage[dis_num[1]];
                tooltip2 = dis_tooltip[dis_num[1]];
            }
            if (mouse_left >= 1) and(cooldown <= 0) and(dis_num[1] = 0) and(dis_num[2] = 0) and(popup = "") and(custom > 1) {
                popup = "disadvantages";
                cooldown = 8000;
                temp = 1;
            }
            if (mouse_left >= 1) and(mouse_x <= 830) and(dis_num[1] > 0) and(dis_num[2] = 0) and(cooldown <= 0) and(points + 20 <= maxpoints) and(custom > 1) {
                points += 20;
                dis[1] = "";
                dis_num[1] = 0;
                cooldown = 8000;
        ...
        if (scr_hit(810, 610, 1014, 639) = true) {
            if (dis_num[2] != 0) {
                tooltip = disadvantage[dis_num[2]];
                tooltip2 = dis_tooltip[dis_num[2]];
            }
            if (mouse_left >= 1) and(cooldown <= 0) and(dis_num[2] = 0) and(dis_num[3] = 0) and(dis_num[1] > 0) and(popup = "") and(custom > 1) {
                popup = "disadvantages";
                cooldown = 8000;
                temp = 2;
            }
            if (mouse_left >= 1) and(mouse_x <= 830) and(dis_num[2] > 0) and(dis_num[3] = 0) and(cooldown <= 0) and(points + 20 <= maxpoints) and(custom > 1) {
                points += 20;
                dis[2] = "";
                dis_num[2] = 0;
                cooldown = 8000;
        ...
        if (scr_hit(810, 630, 1014, 659) = true) {
            if (dis_num[3] != 0) {
                tooltip = disadvantage[dis_num[3]];
                tooltip2 = dis_tooltip[dis_num[3]];
            }
            if (mouse_left >= 1) and(cooldown <= 0) and(dis_num[3] = 0) and(dis_num[4] = 0) and(dis_num[2] > 0) and(popup = "") and(custom > 1) {
                popup = "disadvantages";
                cooldown = 8000;
                temp = 3;
            }
            if (mouse_left >= 1) and(mouse_x <= 830) and(dis_num[3] > 0) and(dis_num[4] = 0) and(cooldown <= 0) and(points + 20 <= maxpoints) and(custom > 1) {
                points += 20;
                dis[3] = "";
                dis_num[3] = 0;
                cooldown = 8000;
        ...
        if (scr_hit(810, 650, 1014, 679) = true) {
            if (dis_num[4] != 0) {
                tooltip = disadvantage[dis_num[4]];
                tooltip2 = dis_tooltip[dis_num[4]];
            }
            if (mouse_left >= 1) and(cooldown <= 0) and(dis_num[4] = 0) and(popup = "") and(dis_num[3] > 0) and(custom > 1) {
                popup = "disadvantages";
                cooldown = 8000;
                temp = 4;
            }
            if (mouse_left >= 1) and(mouse_x <= 830) and(dis_num[4] > 0) and(cooldown <= 0) and(points + 20 <= maxpoints) and(custom > 1) {
                points += 20;
                dis[4] = "";
                dis_num[4] = 0;
                cooldown = 8000;
    ...
    if (popup = "advantages") {
        ...
        var i, ha, ha2, disable;
        i = 0;
        ha = string(adv[1]) + string(adv[2]) + string(adv[3]) + string(adv[4]);
        ha2 = string(dis[1]) + string(dis[2]) + string(dis[3]) + string(dis[4]);
        repeat(14) {
            i += 1;
            disable = 0;
            if (advantage[i] != "") {
                draw_set_color(38144);
                draw_set_alpha(1);
                if (string_count(advantage[i], ha) > 0) then draw_set_alpha(0.5);

                if (advantage[i] = "Psyker Abundance") and(string_count("Psyker Intolerant", ha2) > 0) {
                    disable = 1;
                    draw_set_alpha(0.5);
                }
                if (advantage[i] = "Reverent Guardians") and(string_count("Suspicious", ha2) > 0) {
                    disable = 1;
                    draw_set_alpha(0.5);
                }
                if (advantage[i] = "Tech-Brothers") and(string_count("Tech-Heresy", ha2) > 0) {
                    disable = 1;
                    draw_set_alpha(0.5);
                }
                ...
                if (scr_hit(436, 230 + (i * 20), 436 + string_width(string_hash_to_newline(advantage[i])), 249 + (i * 20)) = true) {
                    tooltip = advantage[i];
                    tooltip2 = advantage_tooltip[i];
                    draw_set_color(c_white);
                    draw_set_alpha(0.2);
                    draw_text(436, 230 + (i * 20), string_hash_to_newline(advantage[i]));
                }
        ...
        repeat(14) {
            ...
            if (advantage[i] != "") {
                ...
                if (scr_hit(670, 230 + ((i - 14) * 20), 670 + string_width(string_hash_to_newline(advantage[i])), 249 + ((i - 14) * 20)) = true) {
                    tooltip = advantage[i];
                    tooltip2 = advantage_tooltip[i];
                    draw_set_color(c_white);
                    draw_set_alpha(0.2);
        ...
        repeat(14) {
            ...
            if (advantage[i] != "") {
                ...
                if (scr_hit(904, 230 + ((i - 28) * 20), 904 + string_width(string_hash_to_newline(advantage[i])), 249 + ((i - 28) * 20)) = true) {
                    tooltip = advantage[i];
                    tooltip2 = advantage_tooltip[i];
                    draw_set_color(c_white);
                    draw_set_alpha(0.2);
    ...
    if (popup = "disadvantages") {
        ...
        var i, ha, ha2, disable;
        i = 0;
        ha = string(dis[1]) + string(dis[2]) + string(dis[3]) + string(dis[4]);
        ha2 = string(adv[1]) + string(adv[2]) + string(adv[3]) + string(adv[4]);
        repeat(14) {
            i += 1;
            disable = 0;
            if (disadvantage[i] != "") {
                draw_set_color(38144);
                draw_set_alpha(1);
                if (string_count(disadvantage[i], ha) > 0) then draw_set_alpha(0.5);

                if (disadvantage[i] = "Psyker Intolerant") and(string_count("Psyker Abundance", ha2) > 0) {
                    disable = 1;
                    draw_set_alpha(0.5);
                }
                if (disadvantage[i] = "Suspicious") and(string_count("Reverent Guardians", ha2) > 0) {
                    disable = 1;
                    draw_set_alpha(0.5);
                }
                if (disadvantage[i] = "Tech-Heresy") and(string_count("Tech-Brothers", ha2) > 0) {
                    disable = 1;
                    draw_set_alpha(0.5);
                }
                if (disadvantage[i] = "Blood Debt") and(fleet_type = 3) {
                    disable = 1;
                    draw_set_alpha(0.5);
                }
                ...
                if (scr_hit(436, 230 + (i * 20), 436 + string_width(string_hash_to_newline(disadvantage[i])), 249 + (i * 20)) = true) {
                    tooltip = disadvantage[i];
                    tooltip2 = dis_tooltip[i];
                    draw_set_color(c_white);
                    draw_set_alpha(0.2);
                    draw_text(436, 230 + (i * 20), string_hash_to_newline(disadvantage[i]));
                }
        ...
        repeat(14) {
            ...
            if (disadvantage[i] != "") {
                ...
                if (scr_hit(670, 230 + ((i - 14) * 20), 670 + string_width(string_hash_to_newline(disadvantage[i])), 249 + ((i - 14) * 20)) = true) {
                    tooltip = disadvantage[i];
                    tooltip2 = dis_tooltip[i];
                    draw_set_color(c_white);
                    draw_set_alpha(0.2);
        ...
        repeat(14) {
            ...
            if (disadvantage[i] != "") {
                ...
                if (scr_hit(904, 230 + ((i - 28) * 20), 904 + string_width(string_hash_to_newline(disadvantage[i])), 249 + ((i - 28) * 20)) = true) {
                    tooltip = disadvantage[i];
                    tooltip2 = dis_tooltip[i];
                    draw_set_color(c_white);
                    draw_set_alpha(0.2);
...
if (slide = 3) {
    ...
    if (fleet_type = 1) {
        ...
        if (scr_hit(525, 285, 525 + 32, 285 + 32) = true) and(mouse_left >= 1) and(cooldown <= 0) and(custom > 1) {
            ...
            onceh = 0;
            cooldown = 8000;
            if (homeworld = "Dead") and(onceh = 0) {
                homeworld = "Ice";
                onceh = 1;
            }
            if (homeworld = "Ice") and(onceh = 0) {
                homeworld = "Temperate";
                onceh = 1;
            }
            if (homeworld = "Temperate") and(onceh = 0) {
                homeworld = "Feudal";
                onceh = 1;
            }
            if (homeworld = "Feudal") and(onceh = 0) {
                homeworld = "Shrine";
                onceh = 1;
            }
            if (homeworld = "Shrine") and(onceh = 0) {
                homeworld = "Agri";
                onceh = 1;
            }
            if (homeworld = "Agri") and(onceh = 0) {
                homeworld = "Death";
                onceh = 1;
            }
            if (homeworld = "Death") and(onceh = 0) {
                homeworld = "Hive";
                onceh = 1;
            }
            if (homeworld = "Hive") and(onceh = 0) {
                homeworld = "Forge";
                onceh = 1;
            }
            if (homeworld = "Forge") and(onceh = 0) {
                homeworld = "Desert";
                onceh = 1;
            }
            if (homeworld = "Desert") and(onceh = 0) {
                homeworld = "Lava";
                onceh = 1;
            }
            if (homeworld = "Lava") and(onceh = 0) {
                homeworld = "Dead";
                onceh = 1;
            }
        }
    ...
    if (fleet_type != 3) {
        ...
        yar = 0;
        if (scr_hit(858, 221, 858 + 32, 221 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(fleet_type = 1) {
            cooldown = 8000;
            var onceh;
            onceh = 0;
            if (recruiting_exists = 1) and(onceh = 0) {
                recruiting_exists = 0;
                onceh = 1;
            }
            if (recruiting_exists = 0) and(onceh = 0) {
                recruiting_exists = 1;
                onceh = 1;
            }
        }
        ...
        if (recruiting_exists = 1) {
            ...
            if (scr_hit(865, 285, 865 + 32, 285 + 32) = true) and(mouse_left >= 1) and(cooldown <= 0) and(custom > 1) {
                ...
                onceh = 0;
                cooldown = 8000;
                if (recruiting = "Dead") and(onceh = 0) {
                    recruiting = "Ice";
                    onceh = 1;
                }
                if (recruiting = "Ice") and(onceh = 0) {
                    recruiting = "Temperate";
                    onceh = 1;
                }
                if (recruiting = "Temperate") and(onceh = 0) {
                    recruiting = "Feudal";
                    onceh = 1;
                }
                if (recruiting = "Feudal") and(onceh = 0) {
                    recruiting = "Shrine";
                    onceh = 1;
                }
                if (recruiting = "Shrine") and(onceh = 0) {
                    recruiting = "Agri";
                    onceh = 1;
                }
                if (recruiting = "Agri") and(onceh = 0) {
                    recruiting = "Death";
                    onceh = 1;
                }
                if (recruiting = "Death") and(onceh = 0) {
                    recruiting = "Hive";
                    onceh = 1;
                }
                if (recruiting = "Hive") and(onceh = 0) {
                    recruiting = "Forge";
                    onceh = 1;
                }
                if (recruiting = "Forge") and(onceh = 0) {
                    recruiting = "Desert";
                    onceh = 1;
                }
                if (recruiting = "Desert") and(onceh = 0) {
                    recruiting = "Lava";
                    onceh = 1;
                }
                if (recruiting = "Lava") and(onceh = 0) {
                    recruiting = "Dead";
                    onceh = 1;
                }
            }
    ...
    if (fleet_type = 1) {
        ...
        yar = 0;
        if (homeworld_rule = 1) then yar = 1;
        draw_sprite(spr_creation_check, yar, 445, 512);
        yar = 0;
        if (scr_hit(445, 512, 445 + 32, 512 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(homeworld_rule != 1) {
            cooldown = 8000;
            homeworld_rule = 1;
        }
        if (scr_hit(445, 512, 670, 512 + 32) = true) {
        ...
        yar = 0;
        if (homeworld_rule = 2) then yar = 1;
        draw_sprite(spr_creation_check, yar, 445, 544);
        yar = 0;
        if (scr_hit(445, 544, 445 + 32, 544 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(homeworld_rule != 2) {
            cooldown = 8000;
            homeworld_rule = 2;
        }
        if (scr_hit(445, 544, 620, 544 + 32) = true) {
        ...
        yar = 0;
        if (homeworld_rule = 3) then yar = 1;
        draw_sprite(spr_creation_check, yar, 445, 576);
        yar = 0;
        if (scr_hit(445, 576, 445 + 32, 576 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(homeworld_rule != 3) {
            cooldown = 8000;
            homeworld_rule = 3;
        }
        if (scr_hit(445, 576, 670, 576 + 32) = true) {
            tooltip = "Planetary Governer";
    ...
    if (scr_hit(800, 480, 1000, 510) = true) {
        tooltip = "Aspirant Trial";
        tooltip2 = "A special challenge is needed for Aspirants to be judged worthy of becoming Astartes.  After completing the Trial they then become a Neophyte, beginning implantation and training.";
    }
    ...
    if (scr_hit(750, 502, 750 + 32, 502 + 32) = true) and(mouse_left >= 1) and(cooldown <= 0) and(custom > 1) {
        ...
        onceh = 0;
        cooldown = 8000;
        if (aspirant_trial = "Apprenticeship") and(onceh = 0) {
            aspirant_trial = "Challenge";
            onceh = 1;
        }
        if (aspirant_trial = "Challenge") and(onceh = 0) {
            aspirant_trial = "Knowledge of Self";
            onceh = 1;
        }
        if (aspirant_trial = "Knowledge of Self") and(onceh = 0) {
            aspirant_trial = "Exposure";
            onceh = 1;
        }
        if (aspirant_trial = "Exposure") and(onceh = 0) {
            aspirant_trial = "Survival of the Fittest";
            onceh = 1;
        }
        if (aspirant_trial = "Survival of the Fittest") and(onceh = 0) {
            aspirant_trial = "Hunting the Hunter";
            onceh = 1;
        }
        if (aspirant_trial = "Hunting the Hunter") and(onceh = 0) {
            aspirant_trial = "Blood Duel";
            onceh = 1;
        }
        if (aspirant_trial = "Blood Duel") and(onceh = 0) {
    ...
    if (race[100, 17] != 0) {
        ...
        if (scr_hit(445, 665, 620, 690) = true) {
        ...
        if (scr_hit(437, 688, 437 + 32, 688 + 32) = true) and(mouse_left >= 1) and(cooldown <= 0) and(custom > 1) {
            ...
            onceh = 0;
            cooldown = 8000;
            if (discipline = "default") and(onceh = 0) {
                discipline = "rune Magick";
                onceh = 1;
            }
            if (discipline = "rune Magick") and(onceh = 0) {
                discipline = "telekinesis";
                onceh = 1;
            }
            if (discipline = "telekinesis") and(onceh = 0) {
                discipline = "pyromancy";
                onceh = 1;
            }
            if (discipline = "pyromancy") and(onceh = 0) {
                discipline = "biomancy";
                onceh = 1;
            }
            if (discipline = "biomancy") and(onceh = 0) {
                discipline = "default";
                onceh = 1;
            }
        }
...
if (slide = 4) {
    ...
    if (shader_is_compiled(sReplaceColor)) {
        ...
        if (col_special <= 1) {
            draw_sprite(spr_aquila_colors, 6, 444, 252);
            draw_sprite(spr_aquila_colors, 8, 444, 252);
        }
        if (col_special >= 2) {
            draw_sprite(spr_aquila_colors, 6, 444, 252);
            draw_sprite(spr_aquila_colors, 9, 444, 252);
        }
    ...
    if (custom > 1) {
        ...
        if (text_selected = "battle_cry") and(text_bar <= 30) then draw_text_ext(580, 144, string_hash_to_newline(string(battle_cry) + "|!"), -1, 580);
        var wid, hei;
        wid = max(580, string_width_ext(string_hash_to_newline(battle_cry), -1, 580));
        hei = string_height_ext(string_hash_to_newline(battle_cry), -1, 580);
        if (scr_hit(580 - 2, 144 - 2, 582 + wid, 146 + hei)) {
            obj_cursor.image_index = 2;
            if (mouse_left >= 1) and(cooldown <= 0) and(!instance_exists(obj_creation_popup)) {
                text_selected = "battle_cry";
                cooldown = 8000;
                keyboard_string = battle_cry;
            }
        }
    ...
    draw_set_alpha(1);
    if (custom < 2) then draw_set_alpha(0.5);
    str = "Primary: " + string(col[main_color]);
    x8 = 620;
    y8 = 252;
    wid = (string_width(string_hash_to_newline(str)) / 2) + 4;
    hei = (string_height(string_hash_to_newline(str)) / 2) + 4;
    draw_rectangle(x8, y8, x8 + wid, y8 + hei, 0);
    draw_set_color(0);
    ...
    if (scr_hit(x8, y8, x8 + wid, y8 + hei) = true) and(!instance_exists(obj_creation_popup)) {
        ...
        if (mouse_left >= 1) and(cooldown <= 0) and(custom > 1) {
            cooldown = 8000;
            var pp;
            pp = instance_create(0, 0, obj_creation_popup);
            pp.type = 1;
        }
    }
    ...
    if (custom < 2) then draw_set_alpha(0.5);
    yar = 0;
    if (col_special = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, 437, 500);
    yar = 0;
    ...
    if (custom < 2) then draw_set_alpha(0.5);
    yar = 0;
    if (col_special = 2) then yar = 1;
    draw_sprite(spr_creation_check, yar, 554, 500);
    yar = 0;
    ...
    if (custom < 2) then draw_set_alpha(0.5);
    yar = 0;
    if (col_special = 3) then yar = 1;
    draw_sprite(spr_creation_check, yar, 662, 500);
    yar = 0;
    ...
    if (custom < 2) then draw_set_alpha(0.5);
    yar = 0;
    if (trim = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, 770, 500);
    yar = 0;
    if (scr_hit(770, 500, 770 + 32, 500 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        ...
        var onceh;
        onceh = 0;
        if (trim = 1) and(onceh = 0) {
            trim = 0;
            onceh = 1;
        }
        if (trim = 0) and(onceh = 0) {
            trim = 1;
            onceh = 1;
        }
    }
    ...
    repeat(13) {
        ...
        if (race[c, ide] != 0) {
            ...
            draw_set_color(0);
            draw_text(xxx, yyy, string_hash_to_newline(role[c, ide]));
            if (scr_hit(xxx, yyy, 1150, yyy + 20) = true) and(!instance_exists(obj_creation_popup)) {
                if (custom = 2) then draw_set_alpha(0.2);
                if (custom < 2) then draw_set_alpha(0.1);
                draw_set_color(c_white);
                draw_rectangle(xxx, yyy, 1150, yyy + 20, 0);
                draw_set_alpha(1);
                tooltip = string(role[c, ide]) + " Settings";
    ...
    draw_sprite(spr_creation_check, yar, 860, 680);
    yar = 0;
    if (scr_hit(860, 680, 1150, 700) = true) and(!instance_exists(obj_creation_popup)) {
        tooltip = "Specialist Distribution";
        tooltip2 = "Check if you wish for your Companies to be uniform and each contain " + string(role[100, 10]) + "s and " + string(role[100, 9]) + "s.";
    }
    if (scr_hit(860, 680, 860 + 32, 680 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        ...
        var onceh;
        onceh = 0;
        if (equal_specialists = 1) and(onceh = 0) {
            equal_specialists = 0;
            onceh = 1;
        }
        if (equal_specialists != 1) and(onceh = 0) {
    ...
    draw_text_transformed(860 + 30, 680 + 4, string_hash_to_newline("Equal Specialist Distribution"), 0.4, 0.4, 0);
    draw_set_alpha(1);

    yar = 0;
    if (load_to_ships = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, 860, 680 + 40);
    yar = 0;
    if (scr_hit(860, 680 + 40, 1005, 700 + 40) = true) and(!instance_exists(obj_creation_popup)) {
    ...
    if (scr_hit(860, 680 + 40, 860 + 32, 680 + 32 + 40) = true) and(cooldown <= 0) and(mouse_left >= 1) and(!instance_exists(obj_creation_popup)) {
        ...
        var onceh;
        onceh = 0;
        if (load_to_ships = 1) and(onceh = 0) {
            load_to_ships = 0;
            onceh = 1;
        }
        if (load_to_ships != 1) and(onceh = 0) {
    ...
    draw_text_transformed(860 + 30, 680 + 4 + 40, string_hash_to_newline("Load to Ships"), 0.4, 0.4, 0);

    yar = 0;
    if (load_to_ships = 2) then yar = 1;
    draw_sprite(spr_creation_check, yar, 1010, 680 + 40);
    yar = 0;
    if (scr_hit(1010, 680 + 40, 1150, 700 + 40) = true) and(!instance_exists(obj_creation_popup)) {
    ...
    if (scr_hit(1010, 680 + 40, 1020 + 32, 680 + 32 + 40) = true) and(cooldown <= 0) and(mouse_left >= 1) and(!instance_exists(obj_creation_popup)) {
        ...
        var onceh;
        onceh = 0;
        if (load_to_ships = 2) and(onceh = 0) {
            load_to_ships = 0;
            onceh = 1;
        }
        if (load_to_ships != 2) and(onceh = 0) {
    ...
    draw_text_transformed(1010 + 30, 680 + 4 + 40, string_hash_to_newline("Load (Sans Escorts)"), 0.4, 0.4, 0);
    ...
    if (!instance_exists(obj_creation_popup)) {
        ...
        if (scr_hit(540, 547, 800, 725) = true) {
        ...
        if (race[100, 14] != 0) {
            draw_set_color(38144);
            if (hchaplain = "") then draw_set_color(c_red);
        ...
        if (race[100, 17] != 0) {
            draw_set_color(38144);
            if (clibrarian = "") then draw_set_color(c_red);
        ...
        if (race[100, 16] != 0) {
            draw_set_color(38144);
            if (fmaster = "") then draw_set_color(c_red);
        ...
        draw_set_color(38144);
        if (recruiter = "") then draw_set_color(c_red);
        ...
        draw_set_color(38144);
        if (admiral = "") then draw_set_color(c_red);
...
if (slide = 5) {
    ...
    y1 = 260;
    yar = 0;
    if (preomnor = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, x1, y1);
    yar = 0;
    if (scr_hit(x1, y1, x1 + 32, y1 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        cooldown = 8000;
        var onceh;
        onceh = 0;
        if (preomnor = 1) and(onceh = 0) {
            preomnor = 0;
            mutations_selected -= 1;
            onceh = 1;
        }
        if (preomnor != 1) and(onceh = 0) and(mutations > mutations_selected) {
            preomnor = 1;
            mutations_selected += 1;
            onceh = 1;
        }
    ...
    if (scr_hit(x1, y1, 700, y1 + 20) = true) {
        tooltip = "Anemic Preomnor";
        tooltip2 = "Your Astartes lack the detoxifying gland called the Preomnor- they are more susceptible to poisons and toxins.";
    }

    y1 += spac;
    yar = 0;
    if (voice = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, x1, y1);
    yar = 0;
    if (scr_hit(x1, y1, x1 + 32, y1 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        cooldown = 8000;
        var onceh;
        onceh = 0;
        if (voice = 1) and(onceh = 0) {
            voice = 0;
            mutations_selected -= 1;
            onceh = 1;
            disposition[2] += 8;
        }
        if (voice != 1) and(onceh = 0) and(mutations > mutations_selected) {
            voice = 1;
            mutations_selected += 1;
            onceh = 1;
            disposition[2] -= 8;
    ...
    if (scr_hit(x1, y1, 700, y1 + 20) = true) {
        tooltip = "Disturbing Voice";
        tooltip2 = "Your Astartes have a voice like a creaking door or a rumble.  Decreases Imperium and Imperial Guard disposition.";
    }

    y1 += spac;
    yar = 0;
    if (doomed = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, x1, y1);
    yar = 0;
    if (scr_hit(x1, y1, x1 + 32, y1 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        cooldown = 8000;
        var onceh;
        onceh = 0;
        if (doomed = 1) and(onceh = 0) {
            doomed = 0;
            mutations_selected -= 4;
            onceh = 1;
            disposition[1] += 8;
            disposition[6] -= 8;
        }
        if (doomed != 1) and(onceh = 0) and(mutations > mutations_selected) {
            doomed = 1;
            mutations_selected += 4;
            onceh = 1;
            disposition[1] -= 8;
    ...
    if (scr_hit(x1, y1, 700, y1 + 20) = true) {
        tooltip = "Doomed";
        tooltip2 = "Your Chapter cannot make more Astartes until enough research is generated.  Counts as four mutations.";
    }

    y1 += spac;
    yar = 0;
    if (lyman = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, x1, y1);
    yar = 0;
    if (scr_hit(x1, y1, x1 + 32, y1 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        cooldown = 8000;
        var onceh;
        onceh = 0;
        if (lyman = 1) and(onceh = 0) {
            lyman = 0;
            mutations_selected -= 1;
            onceh = 1;
        }
        if (lyman != 1) and(onceh = 0) and(mutations > mutations_selected) {
            lyman = 1;
            mutations_selected += 1;
            onceh = 1;
        }
    ...
    if (scr_hit(x1, y1, 700, y1 + 20) = true) {
        tooltip = "Faulty Lyman's Ear";
        tooltip2 = "Lacking a working Lyman's ear, all deep-striked Astartes recieve moderate penalties to both attack and defense.";
    }

    y1 += spac;
    yar = 0;
    if (omophagea = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, x1, y1);
    yar = 0;
    if (scr_hit(x1, y1, x1 + 32, y1 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        cooldown = 8000;
        var onceh;
        onceh = 0;
        if (omophagea = 1) and(onceh = 0) {
            omophagea = 0;
            mutations_selected -= 1;
            onceh = 1;
        }
        if (omophagea != 1) and(onceh = 0) and(mutations > mutations_selected) {
            omophagea = 1;
            mutations_selected += 1;
            onceh = 1;
        }
    ...
    if (scr_hit(x1, y1, 700, y1 + 20) = true) {
        tooltip = "Hyper-Stimulated Omophagea";
        tooltip2 = "After every battle the Astartes have a chance to feast upon their fallen enemies, or seldom, their allies.";
    }

    y1 += spac;
    yar = 0;
    if (ossmodula = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, x1, y1);
    yar = 0;
    if (scr_hit(x1, y1, x1 + 32, y1 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        cooldown = 8000;
        var onceh;
        onceh = 0;
        if (ossmodula = 1) and(onceh = 0) {
            ossmodula = 0;
            mutations_selected -= 1;
            onceh = 1;
        }
        if (ossmodula != 1) and(onceh = 0) and(mutations > mutations_selected) {
            ossmodula = 1;
            mutations_selected += 1;
            onceh = 1;
        }
    ...
    if (scr_hit(x1, y1, 700, y1 + 20) = true) {
        tooltip = "Hyperactive Ossmodula";
        tooltip2 = "Instead of wound tissue bone is generated; Apothecaries must spend twice the normal time healing your Astartes.";
    }

    y1 += spac;
    yar = 0;
    if (zygote = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, x1, y1);
    yar = 0;
    if (scr_hit(x1, y1, x1 + 32, y1 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        cooldown = 8000;
        var onceh;
        onceh = 0;
        if (zygote = 1) and(onceh = 0) {
            zygote = 0;
            mutations_selected -= 2;
            onceh = 1;
        }
        if (zygote != 1) and(onceh = 0) and(mutations > mutations_selected) {
            zygote = 1;
            mutations_selected += 2;
            onceh = 1;
        }
    ...
    if (scr_hit(x1, y1, 700, y1 + 20) = true) {
        tooltip = "Lost Zygote";
        tooltip2 = "One of the Zygotes is faulty or missing.  The Astartes only have one each and generate half the normal Gene-Seed.";
    }
    ...
    if (scr_hit(x1, y1, x1 + 32, y1 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        ...
        var onceh;
        onceh = 0;
        if (membrane = 1) and(onceh = 0) {
            membrane = 0;
            mutations_selected -= 1;
            onceh = 1;
        }
        if (membrane != 1) and(onceh = 0) and(mutations > mutations_selected) {
            membrane = 1;
            mutations_selected += 1;
            onceh = 1;
        }
    ...
    if (scr_hit(x1, y1, 1020, y1 + 20) = true) {
        tooltip = "Inactive Sus-an Membrane";
        tooltip2 = "Your Astartes do not have a Sus-an Membrane; they cannot enter suspended animation and recieve more casualties as a result.";
    }

    y1 += spac;
    yar = 0;
    if (betchers = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, x1, y1);
    yar = 0;
    if (scr_hit(x1, y1, x1 + 32, y1 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        cooldown = 8000;
        var onceh;
        onceh = 0;
        if (betchers = 1) and(onceh = 0) {
            betchers = 0;
            mutations_selected -= 1;
            onceh = 1;
        }
        if (betchers != 1) and(onceh = 0) and(mutations > mutations_selected) {
            betchers = 1;
            mutations_selected += 1;
            onceh = 1;
        }
    ...
    if (scr_hit(x1, y1, 1020, y1 + 20) = true) {
        tooltip = "Missing Betchers Gland";
        tooltip2 = "Your Astartes cannot spit acid, and as a result, have slightly less attack in melee combat.";
    }

    y1 += spac;
    yar = 0;
    if (catalepsean = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, x1, y1);
    yar = 0;
    if (scr_hit(x1, y1, x1 + 32, y1 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        cooldown = 8000;
        var onceh;
        onceh = 0;
        if (catalepsean = 1) and(onceh = 0) {
            catalepsean = 0;
            mutations_selected -= 1;
            onceh = 1;
        }
        if (catalepsean != 1) and(onceh = 0) and(mutations > mutations_selected) {
            catalepsean = 1;
            mutations_selected += 1;
            onceh = 1;
        }
    ...
    if (scr_hit(x1, y1, 1020, y1 + 20) = true) {
        tooltip = "Mutated Catalepsean Node";
        tooltip2 = "Your Astartes cannot sleep portions of their brains at a time, or generally at all.  They have a slight decrease to attack.";
    }

    y1 += spac;
    yar = 0;
    if (secretions = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, x1, y1);
    yar = 0;
    if (scr_hit(x1, y1, x1 + 32, y1 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        cooldown = 8000;
        var onceh;
        onceh = 0;
        if (secretions = 1) and(onceh = 0) {
            secretions = 0;
            mutations_selected -= 1;
            onceh = 1;
            disposition[2] += 8;
        }
        if (secretions != 1) and(onceh = 0) and(mutations > mutations_selected) {
            secretions = 1;
            mutations_selected += 1;
            onceh = 1;
            disposition[2] -= 8;
    ...
    if (scr_hit(x1, y1, 1020, y1 + 20) = true) {
        tooltip = "Oolitic Secretions";
        tooltip2 = "Either by secretions or radiation, your Astartes have an unusual or strange skin color.  Decreases disposition.";
    }

    y1 += spac;
    yar = 0;
    if (occulobe = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, x1, y1);
    yar = 0;
    if (scr_hit(x1, y1, x1 + 32, y1 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        cooldown = 8000;
        var onceh;
        onceh = 0;
        if (occulobe = 1) and(onceh = 0) {
            occulobe = 0;
            mutations_selected -= 1;
            onceh = 1;
        }
        if (occulobe != 1) and(onceh = 0) and(mutations > mutations_selected) {
            occulobe = 1;
            mutations_selected += 1;
            onceh = 1;
        }
    ...
    if (scr_hit(x1, y1, 1020, y1 + 20) = true) {
        tooltip = "Oversensitive Occulobe";
        tooltip2 = "Your Astartes are no longer immune to stun grenades, bright lights, and have a massive penalty during morning battles.";
    }

    y1 += spac;
    yar = 0;
    if (mucranoid = 1) then yar = 1;
    draw_sprite(spr_creation_check, yar, x1, y1);
    yar = 0;
    if (scr_hit(x1, y1, x1 + 32, y1 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(!instance_exists(obj_creation_popup)) {
        cooldown = 8000;
        ...
        if (mucranoid != 1) and(onceh = 0) and(mutations > mutations_selected) {
            mucranoid = 1;
            mutations_selected += 1;
            onceh = 1;
            disposition[1] -= 4;
    ...
    if (scr_hit(x1, y1, 1020, y1 + 20) = true) {
        tooltip = "Rampant Mucranoid";
        tooltip2 = "Your Astartes' Mucranoid cannot be turned off; the slime lowers most dispositions and occasionally damages their armour.";
    }
...
if (slide = 6) {
    ...
    draw_set_color(38144);
    draw_set_halign(fa_left);
    draw_text_transformed(580, 118, string_hash_to_newline("Chapter Master Name: "), 0.6, 0.6, 0);
    draw_set_font(fnt_40k_14b);
    ...
    if (custom > 0) and(restarted = 0) {
        ...
        if (text_selected = "cm") and(text_bar <= 30) then draw_text(580, 144, string_hash_to_newline(string(chapter_master_name) + "|"));
        var wid, hei;
        wid = max(400, string_width(string_hash_to_newline(chapter_master_name)));
    ...
    repeat(7) {
        ...
        yar = 0;
        if (chapter_master_melee = h) then yar = 1;
        ...
        if (scr_hit(x6, y6, x6 + 32, y6 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 0) and(restarted = 0) and(!instance_exists(obj_creation_popup)) {
            ...
            var onceh;
            onceh = 0;
            if (chapter_master_melee = h) and(onceh = 0) {
                chapter_master_melee = 0;
                onceh = 1;
            }
            if (chapter_master_melee != h) and(onceh = 0) {
                chapter_master_melee = h;
                onceh = 1;
            }
        }
    ...
    repeat(7) {
        ...
        if (scr_hit(x6, y6, x6 + 32, y6 + 32) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 0) and(restarted = 0) and(!instance_exists(obj_creation_popup)) {
            ...
            var onceh;
            onceh = 0;
            if (chapter_master_ranged = h) and(onceh = 0) {
                chapter_master_ranged = 0;
                onceh = 1;
            }
            if (chapter_master_ranged != h) and(onceh = 0) {
                chapter_master_ranged = h;
                onceh = 1;
            }
        }
        draw_text_transformed(x6 + 30, y6 + 4, string_hash_to_newline(it), 0.4, 0.4, 0);
    ...
    repeat(3) {
        ...
        yar = 0;
        if (chapter_master_specialty = h) then yar = 1;
        draw_sprite(spr_creation_check, yar, x6, y6 + 214);
        yar = 0;

        var nope;
        nope = 0;
        if (h = 3) and((race[100, 17] = 0) or(string_count("Psyker Intolerant", ha2) > 0)) then nope = 1;

        if (scr_hit(x6, y6 + 214, x6 + 32, y6 + 32 + 214) = true) and(cooldown <= 0) and(mouse_left >= 1) and(custom > 1) and(restarted = 0) and(nope = 0) {
            cooldown = 8000;
            var onceh;
            onceh = 0;
            if (chapter_master_specialty != h) and(onceh = 0) {
        ...
        if (scr_hit(x6, y6 + 214, x6 + 162, y6 + 234) = true) and(nope = 0) {
            if (h = 1) {
                tooltip = "Born Leader";
                tooltip2 = "You always know the right words to inspire your men or strike doubt in the hearts of the enemy.  Increases Disposition and Grants a +10% Requisition Income Bonus.";
            }
            if (h = 2) {
                tooltip = "Champion";
                tooltip2 = "Even before your rise to Chapter Master you were a renowned warrior, nearly without compare.  Increases Chapter Master Experience, Melee Damage, and Ranged Damage.";
            }
            if (h = 3) {
                tooltip = "Psyker";
                tooltip2 = "The impossible is nothing to you; despite being a Psyker you have slowly risen to lead a Chapter.  Chapter Master gains every Power within the chosen Discipline.";
            }
        }
