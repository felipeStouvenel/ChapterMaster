...
if (menu != 14) and(instance_exists(obj_shop)) then with(obj_shop) {
    instance_destroy();
}
...
if (menu = 1) and(managing > 0) {
    ...
    repeat(min(man_max, man_see)) {
        ...
        if (temp[101] = string(ma_role[sel]) + " " + string(ma_name[sel]))
            and((temp[102] != ma_armour[sel]) or(temp[104] != ma_gear[sel]) or(temp[106] = ma_mobi[sel]) or(temp[108] != ma_wep1[sel]) or(temp[110] != ma_wep1[sel]) or(temp[114] = "refresh")) then force_tool = 1;
        ...
        /*and ((temp[101]!=string(ma_role[sel])+" "+string(ma_name[sel])) or (temp[104]!=ma_gear[sel]) or (temp[106]!=ma_mobi[sel]))*/
        {
            ...
            if (man[sel] = "man") {
                ...
                temp[100] = "1";
                if (obj_ini.race[cah, ide[sel]] != 1) then temp[100] = string(obj_ini.race[cah, ide[sel]]);


                dr = 0.7 - ((ma_exp[sel] * ma_exp[sel]) / 40000);

                if (ma_gear[sel] = "Rosarius") then dr -= 0.33;
                if (ma_gear[sel] = "Iron Halo") {
                    dr -= 0.33;
                    ach += 20;
                }
                if (ma_mobi[sel] = "Jump Pack") {
                    dr -= 0.1;
                }
                if (ma_mobi[sel] = "Bike") then ach += 25;
                if (ma_wep1[sel] = "Boarding Shield") {
                    ach += 20;
                    acy += 4;
                }
                if (ma_wep2[sel] = "Boarding Shield") {
                    ach += 20;
                    acy += 4;
                }
                if (ma_wep1[sel] = "Storm Shield") {
                    ach += 30;
                    acy += 8;
                }
                if (ma_wep2[sel] = "Storm Shield") {
                    ach += 30;
                    acy += 8;
                }
                ...
                if (ma_armour[sel] = "MK4 Maximus") {
                    ra += 0.05;
                    ma += 0.05;
                }
                if (ma_armour[sel] = "MK5 Heresy") {
                    ma += 0.1;
                    ra -= 0.05;
                    dr += 0.15;
                }
                if (ma_armour[sel] = "MK6 Corvus") {
                    ra += 0.1;
                }
                if (string_count("Artificer", ma_armour[sel]) > 0) {
                    ma += 0.1;
                }
                if (string_count("Terminator", ma_armour[sel]) > 0) {
                    ra -= 0.1;
                    ma += 0.2;
                }
                if (ma_armour[sel] = "Tartaros") {
                    ra -= 0.05;
                    ma += 0.2;
                }
                ...
                if (ma_race[sel] = 1) {
                    ...
                    repeat(4) {
                        j += 1;
                        if (obj_ini.adv[j] = "Slow and Purposeful") then jj = 1;
                    }
                    if (jj = 1) then dr -= 0.2;
                    j = 0;
                    jj = 0;
                    repeat(4) {
                        j += 1;
                        if (obj_ini.adv[j] = "Lightning Warriors") then jj = 1;
                    }
                    if (jj = 1) then dr -= 0.2;
                }
                ...
                if (ma_race[sel] = 1) {
                    ...
                    repeat(4) {
                        j += 1;
                        if (obj_ini.adv[j] = "Melee Enthusiasts") then jj = 1;
                    }
                    if (jj = 1) {
                        ma += 0.15;
                    }
                ...
                if (ui_melee_penalty > 0) {
                    ma = ma * 0.5;
                    ra = ra * 0.75;
                }
                if (ui_ranged_penalty > 0) {
                    ra = ra * 0.5;
                    ma = ma * 0.75;
                }
