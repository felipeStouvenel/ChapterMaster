...
if (type = 99) {
    ...
    if (obj_controller.zoomed = 0) {
        draw_text_transformed(__view_get(e__VW.XView, 0) + 320, __view_get(e__VW.YView, 0) + 60, string_hash_to_newline("SELECT DESTINATION"), 0.5, 0.5, 0);
    }
    if (obj_controller.zoomed = 1) {
        draw_text_transformed(room_width / 2, 60 * 3, string_hash_to_newline("SELECT DESTINATION"), 1.5, 1.5, 0);
    }
...
if (type = 8) and(instance_exists(obj_controller)) {
    ...
    if (target_comp != -1) {
        ...
        repeat(min(obj_controller.man_max, 23)) {
            ...
            draw_set_color(c_gray);
            draw_rectangle(x2 + 29, y2 + 150, x2 + 569, y2 + 175.4, 1);

            if (ma_ar = "") then draw_set_alpha(0.5);

            draw_text_transformed(x2 + 32, y2 + 151, string_hash_to_newline(string(temp1)), 1, 1, 0);
            draw_text_transformed(x2 + 32.5, y2 + 151.5, string_hash_to_newline(string(temp1)), 1, 1, 0);
            draw_set_color(c_gray);
            draw_set_alpha(1);
            ...
            draw_text_transformed(x2 + 38, y2 + 164, string_hash_to_newline(string(temp5)), 1, 1, 0);
            draw_set_color(38144);
    ...
    draw_set_halign(fa_center);
    draw_text(x2 + 173, y2 + 397, string_hash_to_newline("Cancel"));
    draw_text(x2 + 173.5, y2 + 397.5, string_hash_to_newline("Cancel"));
...
if (zm = 0) and(type = 6) and(instance_exists(obj_controller)) { // Changing Equipment
    ...
    if (target_comp != -1) {
        ...
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1016, yy + 335, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1016, yy + 355, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1016, yy + 375, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1016, yy + 395, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1016, yy + 415, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1016, yy + 435, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1016, yy + 455, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        ...
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1170, yy + 335, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1170, yy + 355, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1170, yy + 375, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1170, yy + 395, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1170, yy + 415, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1170, yy + 435, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1170, yy + 455, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        ...
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1324, yy + 335, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1324, yy + 355, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1324, yy + 375, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1324, yy + 395, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1324, yy + 415, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1324, yy + 435, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1324, yy + 455, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        ...
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1478, yy + 335, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1478, yy + 355, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1478, yy + 375, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1478, yy + 395, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1478, yy + 415, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1478, yy + 435, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
        if (item_name[o] != "") {
            if (target_role = o) then check = "x";
            draw_text_transformed(xx + 1478, yy + 455, string_hash_to_newline("[" + string(check) + "] " + string(item_name[o])), mct, 1, 0);
            check = " ";
        }
        o += 1;
    }
